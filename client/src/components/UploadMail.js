...
const MyForm = () => {
  ...
  const handleSubmit=async (e)=>{
    e.preventDefault();
    await postData('http://localhost:8080/api/emailStatus',data) 
  }
      ...
      <div className="grid grid-cols-1 gap-4 p-4">
        ...
        <div>
          ...
          <input
            ...
            name="emailsfile"
            accept="file/*"
            className={`w-full bg-white border-2 border-gray-300 p-2 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-emerald-600 file:text-gray-100`}
          />
        </div>
      </div>
    </div>
